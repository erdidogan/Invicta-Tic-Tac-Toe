<template>
    <section>
        <svg width="380px" height="500px" viewBox="0 0 837 1045"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <div class="message-box">
            ...
            <div class="buttons-con">
                <div class="action-link-wrap">
                    <a href="" @click="goHome" class="link-button">Go to Home Page</a>
                </div>
            </div>
        </div>
    </section>
